...
interface ImplementDao {
    ...
    @Query("SELECT implementsentity.oid, implementsentity.name FROM implementsentity INNER JOIN maintenancejobimplementjoin ON implementsentity.oid=maintenancejobimplementjoin.implements_id WHERE maintenancejobimplementjoin.maintenace_job_id=:maintenanceJobId")
    ...
    @Query("SELECT implementsentity.oid, implementsentity.name FROM implementsentity INNER JOIN jobtypeimplementsjoin ON implementsentity.oid = jobtypeimplementsjoin.implements_id WHERE jobtypeimplementsjoin.job_type_id=:jobTypeId")
